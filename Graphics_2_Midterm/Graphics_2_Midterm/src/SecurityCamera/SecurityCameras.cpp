...
void SecurityCameras::SetupCameras()
{
	...
	camera1->transform.SetPosition(glm::vec3(10140.57f, 9.32f, -54.03f));
	camera1->transform.SetRotation(glm::vec3(-2.00f, 91.10f, 90.0f));
	...
	camera2->transform.SetRotation(glm::vec3(0,0,90.0f));
	...
	camera3->transform.SetRotation(glm::vec3(76.30, -46.30f, 90.0f));
	...
	camera4->transform.SetRotation(glm::vec3(44.80, -61.70, 90.0f));
	...
	camera5->transform.SetRotation(glm::vec3(14.00f, -94.10f, 90.0f));
